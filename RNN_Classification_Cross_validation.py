# -*- coding: utf-8 -*-
"""
Created on Sat Mar  2 14:37:12 2019
...
plt.title("Confusion matrix Sum RNN all descriptors Not normalized")
sn.heatmap(results_sum, annot=True, cmap="YlGnBu", linewidths=5.0)

plt.figure(figsize = (10,10))
plt.title("Confusion matrix Sum RNN all descriptors normalized")
